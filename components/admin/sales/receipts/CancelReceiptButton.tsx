...
import { cancelReceiptAction } from "@/app/admin/(protected)/sales/receipts/[id]/actions";
      ...
      <div className="flex items-start justify-between gap-4">
        <div>
          <h3 className="font-semibold text-red-900">
            Cancel {receiptNumber}?
          </h3>

          <p className="mt-1 text-sm leading-6 text-red-800">
            This will reverse the receipt&apos;s effect from all allocated Sales
            Orders. The receipt will remain in the audit history as Cancelled.
          </p>
        </div>
