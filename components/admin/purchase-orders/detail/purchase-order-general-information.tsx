  ...
  return (
    <div className="grid gap-6 lg:grid-cols-2">
      <DetailSection title="General Information">
        <DetailRow label="PO Number" value={purchaseOrder.po_number} />

        <DetailRow label="Source" value={formatSource(purchaseOrder.source)} />

        <DetailRow label="Currency" value={purchaseOrder.currency_code} />
      ...
      <DetailSection title="Supplier Information">
        ...
        <DetailRow
          ...
          value={purchaseOrder.supplier.contact_name}
        />

        <DetailRow label="Phone" value={purchaseOrder.supplier.phone} />

        <DetailRow label="WhatsApp" value={purchaseOrder.supplier.whatsapp} />

        <DetailRow label="Email" value={purchaseOrder.supplier.email} />

        <DetailRow label="Address" value={supplierAddress || null} />
      </DetailSection>

      <DetailSection title="Commercial Terms">
        <DetailRow label="Payment Terms" value={purchaseOrder.payment_terms} />

        <DetailRow label="Incoterm" value={purchaseOrder.incoterm} />

        <DetailRow label="Lead Time" value={purchaseOrder.lead_time} />

        <DetailRow
          label="Lead Time Days"
          value={purchaseOrder.lead_time_days}
        />

        <DetailRow label="Packaging" value={purchaseOrder.packaging} />

        <DetailRow label="Warranty" value={purchaseOrder.warranty} />
      </DetailSection>
      ...
      <DetailSection title="Delivery Information">
        ...
        <DetailRow label="Loading Port" value={purchaseOrder.loading_port} />
