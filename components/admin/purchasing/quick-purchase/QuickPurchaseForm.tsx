...
export default function QuickPurchaseForm({
  ...
  const [
    ...
    useState<QuickPurchaseTaxTreatment>(
      "no_vat",
    );
  ...
  const [
    ...
    useState<QuickPurchasePaymentStatus>(
      "paid",
    );
  ...
  const [
    ...
    useState<QuickPurchasePaymentMethod>(
      "cash",
    );
  ...
  function handleSubmit() {
    ...
    if (
      ...
      toast.error(
        "Supplier TRN is required for verified VAT purchases.",
      );
  ...
  return (
    <div className="grid gap-6 xl:grid-cols-[1fr_390px]">
      <div className="space-y-6">
        ...
        <section className="rounded-xl border bg-card p-6">
          <h2 className="font-semibold">
            Purchase VAT Treatment
          </h2>

          <p className="mt-1 text-sm text-muted-foreground">
            Choose the tax treatment based on the supplier document you actually have.
          </p>
