...
export type QuickPurchaseProductPickerHandle = {
  focus: () => void;
};

type ProductOption = StockAdjustmentOptions["products"][number];

interface QuickPurchaseProductPickerProps {
  products: StockAdjustmentOptions["products"];
  value: string;
...
export const QuickPurchaseProductPicker = forwardRef<
  QuickPurchaseProductPickerHandle,
  QuickPurchaseProductPickerProps
>(function QuickPurchaseProductPicker(
  {
    products,
    value,
    onChange,
  ...
  function openPicker(selectText = false) {
