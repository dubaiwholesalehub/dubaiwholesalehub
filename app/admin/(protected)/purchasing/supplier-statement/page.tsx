...
} from "@/lib/repositories/supplier-statement.repository";
...
export default async function SupplierStatementPage({
  ...
  const suppliers =
    await getActiveSupplierOptions();
    ...
    <div className="space-y-6">
      ...
      <div>
        ...
        <p className="mt-1 text-sm text-muted-foreground">
          Review supplier purchases, payments, advances and running payable balance.
        </p>
      </div>
      ...
      {!supplierId ? (
        <section className="rounded-xl border bg-card px-6 py-16 text-center">
          ...
          <p className="mt-1 text-sm text-muted-foreground">
            Choose a supplier above to view purchases, payments and payable balance.
          </p>
        </section>
      ) : !statement ? (
        <section className="rounded-xl border bg-card px-6 py-16 text-center">
          ...
          <section className="grid gap-4 md:grid-cols-2">
            <div className="rounded-xl border bg-card p-5">
              ...
              <p className="mt-2 text-2xl font-semibold">
                AED{" "}
                {money(
                  statement.summary.totalOutstandingPurchases,
                )}
              </p>
            </div>
            ...
            <div className="rounded-xl border bg-card p-5">
              <p className="text-sm text-muted-foreground">
                Current Unallocated Supplier Advance
              </p>

              <p className="mt-2 text-2xl font-semibold">
                AED{" "}
                {money(
                  statement.summary.totalUnallocatedAdvance,
                )}
              </p>
            </div>
          </section>
