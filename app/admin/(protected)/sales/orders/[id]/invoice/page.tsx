...
export default async function SalesInvoicePage({
                    ...
                    <div className="flex items-start gap-4">
                        ...
                        <div>
                            ...
                            <p className="mt-2 text-sm leading-6 text-slate-700">
                                Complete the Company Profile before generating
                                an invoice so the seller information comes from
     ...
     */
    const invoice =
        await getOrCreateSalesInvoice(id);
