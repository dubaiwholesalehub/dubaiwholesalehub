/* Migration 174 - Upgrade Receivables / Payables Intelligence to generalized Supplier AP */

create or replace function public.get_receivables_payables_intelligence() returns jsonb language plpgsql security definer
set
