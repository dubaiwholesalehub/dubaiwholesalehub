/*
 * =========================================================
 * 112 — Journal Entry Product Names
 *
 * PURPOSE
 * -------
 *
 * Enrich the formal Journal Entry audit-detail RPC with the
 * human-readable product name.
 *
 * Existing audit identity remains preserved:
 *
 *   productId
 *
 ...
 *   productName
 *
 * Migration 111 remains historical and unchanged.
 * =========================================================
 */
...
begin
   ...
   * Journal Lines
   *
   * Product is enriched from public.products.
   *
   * The UUID remains available for audit traceability.
   * ======================================================= */
...
is
  'Returns one complete formal General Ledger journal entry including header, debit/credit lines, GL account metadata, operational dimensions, human-readable product names, reversal relationships, source information and balancing controls.';